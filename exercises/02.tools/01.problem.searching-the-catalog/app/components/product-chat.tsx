							...
							>
								{m.parts.map((part, i) => {
									...
									if (part.type === 'tool-call') {
										// Server tools that return `{ products }` (searchProducts,
										// findSimilarProducts, recommendProducts) show their result
										// as a stack of ProductCards once execution finishes.
